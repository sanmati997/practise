						...
						if (++i % batchSize == 0) {
							...
							if (uniDataBatch.size() > 0
								...
								if (uniDataBatch.size() > 0) {
									...
									dbCon.executeACATSaveCustomerType(responseObj,intOffset);//, dealIdEntryDeleted, dealIdEntryDelelegalInclusionEntitiesDeletedted, inclusionAdditionalParamsRulesDeleted, legalExclusionEntitiesDeleted, exclusionAdditionalParamsRulesDeleted);
